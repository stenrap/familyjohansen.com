...
buf.push("<div id=\"edit-post-container\"><form id=\"edit-post-form\"><div id=\"edit-post-form-left\"><div class=\"form-group\"><input type=\"text\" name=\"title\" placeholder=\"Post Title\" autofocus=\"autofocus\" required=\"required\" class=\"form-control\"/><div id=\"format-buttons\"></div><div id=\"editor\"></div></div></div><div id=\"edit-post-form-right\"><div id=\"featured-box\" class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\">Featured</h4></div><div class=\"panel-body\"><div role=\"tabpanel\"><ul role=\"tablist\" class=\"nav nav-tabs\"><li role=\"presentation\" class=\"active\"><a href=\"#image\" aria-controls=\"image\" role=\"tab\" data-toggle=\"tab\" class=\"tab-name\">Image</a></li><li role=\"presentation\"><a href=\"#video\" aria-controls=\"video\" role=\"tab\" data-toggle=\"tab\" class=\"tab-name\">Video</a></li></ul><div class=\"tab-content\"><div id=\"image\" role=\"tabpanel\" class=\"tab-pane active\"></div><div id=\"video\" role=\"tabpanel\" class=\"tab-pane\"></div></div></div></div></div><div id=\"status-box\"></div></div></form></div>");;return buf.join("");
}
